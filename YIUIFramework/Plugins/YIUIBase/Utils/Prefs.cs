...
namespace YIUIFramework
{
	...
	public struct Prefs<T>
	{
		...
		private readonly string m_valueKey;
		private RwFlag m_rwFlag;

		private int m_groupKeyVer;
		private readonly IGroupKey m_groupKey;
		private readonly IPrefsAccessor m_accessor;

		private readonly T m_defValue;
	...
	public struct ArrPrefs<T> where T : IComparable
	{
		...
		public void Set(T[] value)
		{
			...
			{
				sb.Append(StrConv.ChrArrSplitLv1).Append(value[i]);
			}
	...
	/// <summary> RwFlag 的枚举扩展方法 </summary>
