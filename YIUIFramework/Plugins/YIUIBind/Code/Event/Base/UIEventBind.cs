...
namespace YIUIBind
{
	...
	{
		[OdinSerialize] [ReadOnly] [HideReferenceObjectPicker] 
		[Required("必须选择")] [HideLabel] [PropertyOrder(-999)]
		...
		/// 当前的UI事件
		/// </summary>
		[OdinSerialize] [HideInInspector] protected UIEventBase m_UIEvent;
