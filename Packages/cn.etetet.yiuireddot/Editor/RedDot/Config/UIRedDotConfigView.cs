...
namespace YIUIFramework.Editor
{
    ...
    internal class UIRedDotConfigView : BaseCreateModule
    {
        ...
        internal ERedDotConfigViewIndexType m_ERedDotConfigViewIndexType = ERedDotConfigViewIndexType.Get;
        ...
        private HashSet<int> m_HashRedDotKeyType = new HashSet<int>();
        ...
        private List<int> GetParentListByEditorData(UIRedDotConfigEditorData data)
        {
            var parentList = new List<int>();

            foreach (var parentData in data.ParentList)
            {
                if (parentData.KeyType == 0)
                {
                    continue;
                }
        ...
        internal bool EditorDataContains(int keyType)
        {
        ...
        [HideLabel]
        internal enum ERedDotConfigViewIndexType
        {
            [LabelText("增")]
            Add = 1,
