...
namespace YIUIFramework.Editor
{
    ...
    internal class UIRedDotConfigEditorData
    {
        ...
        [ShowInInspector]
        [NonSerialized]
        [ShowIf("GetViewIndexType", UIRedDotConfigView.ERedDotConfigViewIndexType.Get)]
        internal string ShowDesc;
        ...
        [ValueDropdown("GetKeyTypesSelectList")]
        [ShowInInspector]
        [OdinSerialize]
        [ShowIf("GetViewIndexType", UIRedDotConfigView.ERedDotConfigViewIndexType.Add)]
        ...
        private IEnumerable GetKeyTypesSelectList()
        {
            ...
            {
                if (key == 0) continue;
                if (!m_UIRedDotConfigView.EditorDataContains(key))
                {
        ...
        internal int Id
        {
            ...
            {
                m_id     = value;
                ShowDesc = RedDotKeyHelper.GetDisplayDesc(m_id);
            }
        }
        ...
        private UIRedDotConfigView.ERedDotConfigViewIndexType GetViewIndexType()
        {
            return m_UIRedDotConfigView.m_ERedDotConfigViewIndexType;
        }
