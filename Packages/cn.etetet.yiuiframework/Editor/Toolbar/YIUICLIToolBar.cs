...
namespace YIUIFramework.Editor
{
    ...
    public static class YIUICLIToolBar
    {
        ...
        const string iconPath = "Packages\\cn.etetet.yiuiframework\\Editor\\Toolbar\\Icon\\icon_ai_cli.png";
        ...
        private static void OnCLIToolbarGUI()
        {
            ...
            var openAIName = YIUIConstHelper.Const.YIUIDefaultOpenAIName;
