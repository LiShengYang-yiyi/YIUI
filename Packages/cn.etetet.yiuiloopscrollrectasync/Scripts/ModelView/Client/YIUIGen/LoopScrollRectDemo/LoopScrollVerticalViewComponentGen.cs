...
namespace ET.Client
{
    ...
    public partial class LoopScrollVerticalViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "LoopScrollRectDemo";
        public const string ResName = "LoopScrollVerticalView";
