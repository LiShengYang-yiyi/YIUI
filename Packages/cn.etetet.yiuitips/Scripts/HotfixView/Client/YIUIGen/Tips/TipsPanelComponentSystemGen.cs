...
namespace ET.Client
{
    ...
    public static partial class TipsPanelComponentSystem
    {
        ...
        private static void UIBind(this TipsPanelComponent self)
        {
            ...
            self.UIWindow.WindowOption = EWindowOption.BanOpenTween|EWindowOption.BanCloseTween|EWindowOption.BanAwaitOpenTween|EWindowOption.BanAwaitCloseTween|EWindowOption.SkipOtherOpenTween|EWindowOption.SkipOtherCloseTween|EWindowOption.SkipHomeOpenTween|EWindowOption.AllowOptionByTween;
