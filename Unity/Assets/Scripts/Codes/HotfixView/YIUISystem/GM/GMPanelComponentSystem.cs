...
namespace ET.Client
{
    ...
    {
        [ObjectSystem]
        public class GMPanelComponentInitializeSystem: YIUIInitializeSystem<GMPanelComponent>
        {
            protected override void YIUIInitialize(GMPanelComponent self)
            {
        ...
        [ObjectSystem]
        public class GMPanelComponentDestroySystem: DestroySystem<GMPanelComponent>
        {
            protected override void Destroy(GMPanelComponent self)
            {
            }
        }
        ...
        [ObjectSystem]
        public class GMPanelComponentUpdateSystem: UpdateSystem<GMPanelComponent>
        {
            protected override void Update(GMPanelComponent self)
            {
