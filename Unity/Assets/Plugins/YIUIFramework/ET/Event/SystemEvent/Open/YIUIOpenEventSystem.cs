...
namespace ET.Client
{
    ...
    public static partial class YIUIEventSystem
    {
        ...
        {
            List<object> iOpenSystems = EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem));
        ...
        {
            List<object> iOpenSystems = EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem<P1>));
            if (iOpenSystems == null)
            {
                return true;
            }
        ...
        {
            List<object> iOpenSystems = EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem<P1, P2>));
            if (iOpenSystems == null)
            {
                return true;
            }
        ...
        {
            List<object> iOpenSystems = EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem<P1, P2, P3>));
            if (iOpenSystems == null)
            {
                return true;
            }
        ...
        {
            List<object> iOpenSystems = EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem<P1, P2, P3, P4>));
            if (iOpenSystems == null)
            {
                return true;
            }
        ...
        public static async ETTask<bool> Open<P1, P2, P3, P4, P5>(Entity component, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
        {
            List<object> iOpenSystems =
                    EventSystem.Instance.typeSystems.GetSystems(component.GetType(), typeof (IYIUIOpenSystem<P1, P2, P3, P4, P5>));
            if (iOpenSystems == null)
            {
                return true;
            }
